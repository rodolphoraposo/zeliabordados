# 🖼️ Zélia Bordados: Galeria Digital e Link-in-Bio - Vitrine de Artesanato

---

## 🎯 O PROBLEMA DE NEGÓCIO: Exposição de Artesanato e Orçamento Personalizado

**Este projeto resolve a dificuldade de expor o portfólio de artesanato e otimizar a solicitação de orçamento.**

Em vez de depender de imagens desorganizadas e solicitações genéricas, este **Sistema de Galeria e Orçamento por Item** oferece uma vitrine elegante e profissional, garantindo que o cliente solicite um orçamento sabendo exatamente a peça que deseja.

> **Resultado Esperado:** Profissionalização da marca, **melhora na primeira impressão visual** e aumento da conversão de visitantes em clientes através de orçamentos específicos e direcionados.
...
## 💻 AS DECISÕES ARQUITETURAIS: Foco em Estabilidade e Apresentação
...
1.  **Clone o repositório:**
    ```bash
    git clone [https://github.com/rodolphoraposo/zeliabordados.git](https://github.com/rodolphoraposo/zeliabordados.git)
    ```
2.  **Abra o projeto:**
    ```bash
    cd zeliabordados
